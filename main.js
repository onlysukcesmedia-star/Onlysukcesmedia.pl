document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', async (e) => {
            ...
            const webhookUrl = 'https://hook.eu1.make.com/prv7gjy5s4pbhgbmhyg5sbnf9hh2xiaj';
            try {
    ...
    if (marqueeContent) {
        ...
        const imageBasePath = isLocalHost ? 'assets/img/' : 'img/';
        const socialProofImages = [
            `${imageBasePath}opinia1.jpg`,
            `${imageBasePath}opinia2.jpg`,
            `${imageBasePath}opinia3.jpg`,
            `${imageBasePath}opinia4.jpg`,
            `${imageBasePath}opinia5.jpg`,
            `${imageBasePath}opinia6.jpg`,
            `${imageBasePath}opinia7.jpg`,
            `${imageBasePath}opinia8.jpg`,
            `${imageBasePath}opinia9.jpg`,
            `${imageBasePath}opinia10.jpg`,
            `${imageBasePath}opinia11.jpg`,
            `${imageBasePath}opinia12.jpg`,
            `${imageBasePath}opinia13.jpg`
        ];
